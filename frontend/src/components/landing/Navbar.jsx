          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <>
                ...
                <Link
                  to="/dashboard"
                  className="hidden sm:inline-flex items-center gap-1.5 h-9 px-4 rounded-full text-[13px] font-medium text-[var(--ink)] hover:bg-[var(--surface-2)] transition-colors"
                >
            ...
            {user ? (
              <>
                <Link
                  to="/dashboard"
                  onClick={() => setOpen(false)}
                  className="flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-[var(--ink)] hover:bg-[var(--surface-2)]"
                >
                ...
                <button
                  type="button"
                  onClick={handleLogout}
                  className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-medium text-[var(--ink)] hover:bg-[var(--surface-2)] text-left"
                >
                  <LogOut size={15} />
                  Logout
                </button>
